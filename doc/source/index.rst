...
* CVXPY started moving to semantic versioning in early 2022. Starting in March 2022 we will
  only update CVXPY 1.1 for bugfix purposes, and we will release minor versions (e.g., 1.2, 1.3)
  much more often.
