...
# TODO: openmp optional/flags may be system dependent, and some systems
# may not have openmp, so compiling with it should be optional
# TODO wheels, however, should be compiled with openmp ...
canon = Extension(
    '_cvxcore',
