...
class det_rootn(Atom):
    ...
    def validate_arguments(self):
        ...
        if n != m:
            raise TypeError("The argument to det_rootn must be a square matrix." )
    ...
    def graph_implementation(self, arg_objs):
        ...
        constraints += [X[0:n, 0:n] == D,
                        ...
                        X[n:2*n, n:2*n] == A]
        # Add the objective.
        D_diag = (D[i, i] for i in xrange(n))
        obj, constr = geo_mean(*D_diag).canonical_form
