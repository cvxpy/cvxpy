...
class Problem(u.Canonical):
    ...
    def _solve(self,
        ...
        self.unpack_results(solution, self._solving_chain, inverse_data,
                            self._symbolic_chain, self._symbolic_inverse_data)
    ...
    def unpack_results(self, solution,
        ...
        symbolic_chain : Chain, optional
            A reduction chain that was used before the solving chain to reformulate
            the problem.
        symbolic_inverse_data : list, optional
            The inverse data returned by applying the symboic_chain to the problem.
        """
