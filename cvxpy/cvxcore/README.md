...
## Making changes in cvxcore visible from CVXPY
...
## Notes about Python files which interact with cvxcore
...
## Miscellaneous notes on cvxcore's C++ implementation
