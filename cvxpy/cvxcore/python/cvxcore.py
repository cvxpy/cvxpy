...
class ProblemData(_object):
    ...
    __swig_setmethods__["param_id"] = _cvxcore.ProblemData_param_id_set
    __swig_getmethods__["param_id"] = _cvxcore.ProblemData_param_id_get
    if _newclass:
        param_id = _swig_property(_cvxcore.ProblemData_param_id_get, _cvxcore.ProblemData_param_id_set)
    __swig_setmethods__["vec_idx"] = _cvxcore.ProblemData_vec_idx_set
    __swig_getmethods__["vec_idx"] = _cvxcore.ProblemData_vec_idx_get
    if _newclass:
        vec_idx = _swig_property(_cvxcore.ProblemData_vec_idx_get, _cvxcore.ProblemData_vec_idx_set)
