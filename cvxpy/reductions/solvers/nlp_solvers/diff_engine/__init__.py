...
This module converts CVXPY expressions to C expression trees for structured
differentiation, shared between the DNLP solver path and the DCP
matrix-stuffing path.
"""
