...
from cvxpy.reductions.solvers.conic_solvers.mpax_conif import MPAX as MPAX_con
from cvxpy.reductions.solvers.conic_solvers.nag_conif import NAG as NAG_con
from cvxpy.reductions.solvers.conic_solvers.osqp_conif import OSQP as OSQP_con
from cvxpy.reductions.solvers.conic_solvers.pdlp_conif import PDLP as PDLP_con
from cvxpy.reductions.solvers.conic_solvers.piqp_conif import PIQP as PIQP_con
from cvxpy.reductions.solvers.conic_solvers.proxqp_conif import PROXQP as PROXQP_con
from cvxpy.reductions.solvers.conic_solvers.qoco_conif import QOCO as QOCO_con
from cvxpy.reductions.solvers.conic_solvers.qpalm_conif import QPALM as QPALM_con
...
solver_conic_intf = [
    OSQP_con(), PIQP_con(), PROXQP_con(), QPALM_con(), DAQP_con(), MPAX_con(),
...
# CONIC_SOLVERS is sorted in order of decreasing solver preference.
CONIC_SOLVERS = [
    s.OSQP,
    s.PIQP,
    s.PROXQP,
