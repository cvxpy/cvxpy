...
class TestKKT_PCPs(BaseTest):
    ...
    def non_vec_pow_nd() -> STH.SolverTestHelper:
        ...
        cons = [
            cp.PowConeND(u, z[0], alpha1),
            cp.PowConeND(u, z[1], alpha2),
            X >= 0,
            cp.sum(X, axis=0) <= 1,
        ]
    ...
    def vec_pow_nd() -> STH.SolverTestHelper:
        ...
        cons = [
            cp.PowConeND(cp.vstack([u, u]), z, np.vstack([alpha1, alpha2]), axis=1),
            X >= 0,
            cp.sum(X, axis=0) <= 1,
        ]
        obj = cp.Maximize(z[0] + z[1])
...
class TestKKT_Flags(BaseTest):
    ...
    def nsd_flag() -> STH.SolverTestHelper:
        ...
        var_pairs = [
            (X, np.array([[-123.0, 123.0, 0.0], [123.0, -123.0, 0.0], [0.0, 0.0, -123.0]]))
        ]
    ...
    def psd_flag() -> STH.SolverTestHelper:
        ...
        var_pairs = [
            (
                ...
                np.array(
                    [
                        [4.00000001, 4.0, -1.05467058, -1.05467058],
                        [4.0, 4.00000001, -1.05467058, -1.05467058],
    ...
    def symmetric_flag() -> STH.SolverTestHelper:
        ...
        var_pairs = [
            (
                ...
                np.array(
                    [
                        [-3.74578525, 4.0, -3.30586268, -3.30586268],
                        [4.0, -3.74578525, -3.30586268, -3.30586268],
    ...
    def nonneg_flag() -> STH.SolverTestHelper:
        ...
        var_pairs = [
            (
                ...
                np.array(
                    [
                        [1.19672119e-07, 4.00000000e00, 1.19672119e-07, 1.19672119e-07],
