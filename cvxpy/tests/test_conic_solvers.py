...
class TestHIGHS(BaseTest):
    ...
    def test_highs_lp_3(self) -> None:
        sth = sths.lp_3()
        sth.prob.solve(solver='HIGHS')
        self.assertEqual(sth.prob.status, cp.settings.UNBOUNDED)
    ...
    def test_highs_socp_0(self) -> None:
        with self.assertRaises(Exception):
            StandardTestSOCPs.test_socp_0(solver='HIGHS')
    ...
    def test_highs_mi_socp_1(self) -> None:
        with self.assertRaises(Exception):
            StandardTestSOCPs.test_mi_socp_1(solver='HIGHS')