...
atoms = [
    ([
        ...
        (maximum, (2, 1), [[-5, 2], [-3, 1], 0, [-1, 2]], Constant([0, 2])),
        (maximum, (2, 2), [[[-5, 2], [-3, 1]], 0, [[5, 4], [-1, 2]]],
            Constant([[5, 4], [0, 2]])),
        (max, (1, 1), [[[-5, 2], [-3, 1]]], Constant([2])),
        (max, (1, 1), [[-5, -10]], Constant([-5])),
        (lambda x: max(x, axis=0), (1, 2), [[[-5, 2], [-3, 1]]], Constant([2, 1]).T),
        (lambda x: max(x, axis=1), (2, 1), [[[-5, 2], [-3, 1]]], Constant([-3, 2])),
        ...
        (lambda x: mixed_norm(x, 1, 1), (1, 1), [[[1, 2, 3], [4, 5, 6]]],
            Constant([21])),
        # (lambda x: mixed_norm(x, 2, 1), (1, 1), [[[3, 1], [4, math.sqrt(3)]]],
        #     Constant([7])),
    ...
    ([
        ...
        (minimum, (2, 1), [[-5, 2], [-3, 1], 0, [1, 2]], Constant([-5, 0])),
        (minimum, (2, 2), [[[-5, 2], [-3, -1]], 0, [[5, 4], [-1, 2]]], Constant([[-5, 0], [-3, -1]])),
        (min, (1, 1), [[[-5, 2], [-3, 1]]], Constant([-5])),
        (min, (1, 1), [[-5, -10]], Constant([-10])),
